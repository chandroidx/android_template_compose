...
sealed interface MlKit {
  sealed interface Vision : Component {
    data object BarcodeScanning : Vision {
      override val navKey: NavKey = BarcodeScanningNavKey
    ...
    data object FaceDetection : Vision {
      override val navKey: NavKey = FaceDetectionNavKey
    ...
    data object FaceMeshDetection : Vision {
      override val navKey: NavKey = FaceMeshDetectionNavKey
    ...
    data object TextRecognition : Vision {
      override val navKey: NavKey = TextRecognitionNavKey
    ...
    data object ImageLabeling : Vision {
      override val navKey: NavKey = ImageLabelingNavKey
    ...
    data object ObjectDetectionAndTracking : Vision {
      override val navKey: NavKey = ObjectDetectionAndTrackingNavKey
    ...
    data object DigitalInkRecognition : Vision {
      override val navKey: NavKey = DigitalInkRecognitionNavKey
    ...
    data object PoseDetection : Vision {
      override val navKey: NavKey = PoseDetectionNavKey
    ...
    data object SelfieSegmentation : Vision {
      override val navKey: NavKey = SelfieSegmentationNavKey
